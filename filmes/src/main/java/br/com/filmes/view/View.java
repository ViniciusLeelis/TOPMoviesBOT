...
import br.com.filmes.controller.ListarHistoricoController;
...
public class View implements Observer{
	...
	public void executa(Update update) throws FileNotFoundException, IOException {
		...
		if(this.searchBehaviour==true){
		...
		}else if (update.message().text().equals("mostrar historico")) {
			setControllerSearch(new ListarHistoricoController(model, this));
			...
			sendResponse = bot.execute(new SendMessage(update.message().chat().id(),
					"Escolha uma das opçoes abaixo :" ).replyMarkup(new ReplyKeyboardMarkup(
			...
			Keyboard replyKeyboardMarkup = new ReplyKeyboardMarkup(new String[] { "listar filmes aleatorios", "listar filmes por genero", "mostrar historico" })
